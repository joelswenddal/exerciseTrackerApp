...
/**
* Retrive exercise events based on the filter, projection and limit parameters
* @param {Object} filter 
...
/**
 * Find the exercise event with the given ID value
 * @param {String} _id 
 * @returns 
 */
...
/**
 * Replace all the properties of the exercise event with the id value provided
 * @param {String} name
 * @param {Number} reps
 * @param {Number} weight 
 * @param {String} unit
...
/**
 * Delete the exercise event with provided id value
 * @param {String} _id 
